...
,
  ...
  fa: {
    ...
    contact: {
      ...
      address: 'نشانی: تهران - شهرستان : تهران - بخش : مرکزی - شهر : تهران - محله : آرارات - بزرگراه کردستان - خیابان حکیم اعظم - پلاک : -19.0 - طبقه : 3 - واحد : 6',
    ...
    dashboard: {
      ...
      welcome: 'خوش آمدید',
      subtitle:
        'کمپین‌های پیامکی خود را مدیریت کنید و عملکرد خود را پیگیری کنید',
      language: 'زبان',
      logout: 'خروج',
