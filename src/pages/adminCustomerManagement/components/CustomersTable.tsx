            ...
            {loading ? (
              ...
              items.map((it, idx) => (
                ...
                >
                  ...
                  <td className='px-4 py-3 text-center text-gray-700'>
                    {it.referrer_agency_name || '-'}
                  </td>
                  <td className='px-4 py-3 text-center text-gray-700'>
                    {it.account_type_name || '-'}
                  </td>
                  {/* <td className="px-4 py-3 text-center text-gray-700">
                  ...
                  <td className='px-4 py-3 text-center text-gray-700'>
                    {formatNumber(it.total_sent)}
                  </td>
                  <td className='px-4 py-3 text-center text-gray-700'>
                    {toPct(it.click_rate)}
                  </td>
                  <td className='px-4 py-3 text-center text-gray-700'>
                    {formatNumber(it.agency_share_with_tax)}
                  </td>
                  <td className='px-4 py-3 text-center text-gray-700'>
                    {formatNumber(it.system_share)}
                  </td>
