              ...
              <div className='mt-6 grid grid-cols-1 md:grid-cols-3 gap-4'>
                <div className='bg-blue-50 rounded-lg p-4'>
                  ...
                  <div className='text-sm text-blue-700'>
                    {t('pricing.intro.payAsYouGo.description') ||
                ...
                <div className='bg-green-50 rounded-lg p-4'>
                  ...
                  <div className='text-sm text-green-700'>
                    {t('pricing.intro.transparent.description') ||
                      '10% tax included in all transactions'}
                  </div>
                </div>
                <div className='bg-purple-50 rounded-lg p-4'>
                  ...
                  <div className='text-sm text-purple-700'>
                    {t('pricing.intro.volume.description') ||
                      'Save more with higher credit purchases'}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='text-center py-8'>
            ...
            <p className='text-xl text-primary-100 mb-6'>
              {t('pricing.cta.description') ||
                'Create your account today and start your first campaign'}
            </p>
