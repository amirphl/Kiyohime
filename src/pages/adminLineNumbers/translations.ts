...
const fa: AdminLineNumbersCopy = {
  ...
  validation: {
    lineNumberRequired: 'سرشماره الزامی است.',
    lineNumberLength: 'سرشماره باید بین ۳ تا ۵۰ کاراکتر باشد.',
  ...
  errors: {
    ...
    lineNumberAlreadyExists: 'این سرشماره قبلاً ثبت شده است.',
    lineNumberValueRequired: 'سرشماره الزامی است.',
    lineNumberLengthInvalid: 'سرشماره باید بین ۳ تا ۵۰ کاراکتر باشد.',
