const contentEn = {
    ...
    linkCharacterInsertedMessage: 'Link will be inserted at the marked position (jo1n.ir/xxxxxx)',
...
const contentFa = {
    ...
    linkCharacterInsertedMessage: 'لینک کوتاه‌شده در محل jo1n.ir/xxxxxx قرار خواهد گرفت.',
