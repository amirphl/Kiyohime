...
const ContentStep: React.FC = () => {
    ...
    const { linkCharacterInserted, insertLinkCharacter, resetLinkCharacter } = useLinkCharacter(
        campaignData.content.text
    );

    const { showDateTimePicker, toggleDateTimePicker } = useScheduleTime(
    ...
    const handleInsertLinkCharacter = () => {
        insertLinkCharacter(textAreaRef, campaignData.content.text || '', handleTextChange);
    };

    const handleDateTimeToggle = () => {
        toggleDateTimePicker((scheduleAt) => updateContent({ scheduleAt }));
    };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
                ...
                <div className="flex flex-col">
                    <LinkInsertionCard
                        ...
                        linkError={linkError}
                        onInsertLinkToggle={handleInsertLinkToggle}
