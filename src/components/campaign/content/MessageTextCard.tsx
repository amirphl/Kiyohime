            ...
            <div className="space-y-4">
                ...
                {insertLink && (
                    <div className="mt-4">
                        ...
                        >
                            {linkCharacterInserted ? linkCharacterInsertedLabel : insertLinkCharacterLabel}
                        </Button>
                        {linkCharacterInserted && (
                ...
                <div className="space-y-2">
                    <div className={`text-sm ${isOverLimit ? 'text-red-600' : 'text-gray-500'}`}>
                        <div className="flex items-center justify-between">
                            <span>{charactersLabel.replace('{count}', String(characterCount))}</span>
                            <span>{totalLabel.replace('{count}', String(totalCharacterCount)).replace('{max}', String(maxCharacters))}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span>{partsLabel.replace('{count}', String(numberOfParts))}</span>
                            <span className="font-medium">{partsCount.replace('{total}', String(totalCharacterCount)).replace('{parts}', String(numberOfParts))}</span>
                        </div>
                    </div>
