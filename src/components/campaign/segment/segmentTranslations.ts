const campaignLevelEn = {
    ...
    level1Description: 'Which of the following should your target audience be consumers of?',
...
const campaignLevelFa = {
    ...
    level1Description: 'مخاطبان هدف شما باید مصرف‌کنندگان کدام یک از موارد زیر باشند؟',
