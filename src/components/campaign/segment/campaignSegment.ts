const campaignLevelEn = {
    ...
    level2Help: 'Select at least one Level 2 item (multiple selection allowed)',
    level2Validation: 'Please select at least one Level 2 item',
    level2Label: 'Level 2',

    // Level 3
    level3: 'Level 3',
    level3Help: 'Select at least one Level 3 item (multiple selection allowed)',
...
const campaignLevelFa = {
    ...
    level2Help: 'حداقل یک سطح ۲ را انتخاب کنید (انتخاب چندگانه مجاز است)',
